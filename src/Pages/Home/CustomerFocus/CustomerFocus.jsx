    ...
    return (
        <div>
            <div id="customer-focus" className="w-[300px] md:w-[350px] mx-auto space-y-8 shadow-[0px_0px_30px_2px_rgba(100,100,111,0.1)] relative p-8">
                {/* top part  */}
                <div>
                    <GoGoal size={40} className="w-[60px] border h-[60px] object-cover rounded-full p-2 bg-slate-100 duration-300 hover:scale-105" src="https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTAxL2pvYjk2OC1lbGVtZW50LTAxMi14LmpwZw.jpg" alt=""
                    />
                    {/* Price Ribbon SVG  */}
                ...
                <div className="space-y-4">
                    ...
                    <h3 className="text-2xl font-bold text-slate-800">Customer Focus Goal</h3>
